...
```{r, message = FALSE, warning = FALSE, echo = F}
missmap(Ins_train_format, main="Missing Values") # using Amelia package
```
...
```{r, message = FALSE, warning = FALSE, echo = F}
missmap(Ins_train_imputed, main="Missing Values") # using Amelia package
```
...
```{r, message = FALSE, warning = FALSE, echo = F}
Ins_eval_cap_imputed$TARGET_FLAG <- Eval_Log_Reg_class 

Ins_eval_cap_imputed$TARGET_AMT <- Eval_TARGET_AMT  
```
